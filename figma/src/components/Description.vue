...
<template>
    ...
    <section>
        <div class="section-left">
            ...
            veniam consequat sunt.</p>
            <button>Download CV</button>
        </div>
        <div class="section-rigth">
            <img src="../assets/sectionImg.svg" alt="" width="440px" height="338px">
        </div>
    </section>
</template>
...
button{
     background-image: linear-gradient(#5222D0 , #FF6196);
     padding: 5px  10px;
     border-radius: 10px;
     border: none;
     width: 180px;
...
button:hover{
    background-image: linear-gradient(#582ace , #df5684);
    color: #fff;
}
p{
    font-weight: 400;
